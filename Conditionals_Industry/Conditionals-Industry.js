...
sickDays!=0 ? console.log('You have '+sickDays+' left and can call off.') :
...
var callOff=prompt('Would you like to call off work today?');
// ternary operator to show the user's choice of calling off or going to work
callOff==true ? console.log('You have the day off!') :
