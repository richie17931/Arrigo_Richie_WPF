...
do{
    ...
    if(day.toUpperCase()!='SUNDAY'){
        var sickDays=null;
        while(sickDays == null || sickDays < 0 || sickDays > 3){
            sickDays=prompt('How many sick days do you have left?(1-3)');
        }
        ...
        callOff.toUpperCase()=='YES' && sickDays < 3 && sickDays > 0 ? console.log('You have the day off!') :
                                                                     console.log('Get ready and get to work!');
        break;
    }
    else{
        quitTest=false; break;
    }
} while(quitTest)
